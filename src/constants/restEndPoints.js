...
export const EXPENSE_URLS = {
  ...
  DELETE_EXPENSE: `${EXPENSE}delete/:uuid/`,
...
export const TRANSACTION_URLS = {
  ...
  DELETE_TRANSACTION: `${TRANSACTION}delete/:uuid/`,
  GET_TRANSACTION: `${TRANSACTION}:uuid/`,
  EDIT_TRANSACTION: `${TRANSACTION}edit/:uuid/`,
...
export const CHEQUE_URLS = {
  ...
  EXTERNAL: {
    ...
    DELETE_HISTORY: `${CHEQUE}${EXTERNAL}${DELETE}history/:uuid/`,
  },
};
